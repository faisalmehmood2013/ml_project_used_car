...
# installed.
TCL_PREFIX='E:/1. Daily Activity/1_Artifical_Intelligence/3_Machine_Learning/2_Machine_Learning_Projects/1_ML_Used_Car_Dataset/venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='E:/1. Daily Activity/1_Artifical_Intelligence/3_Machine_Learning/2_Machine_Learning_Projects/1_ML_Used_Car_Dataset/venv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='E:/1. Daily Activity/1_Artifical_Intelligence/3_Machine_Learning/2_Machine_Learning_Projects/1_ML_Used_Car_Dataset/venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IE:/1. Daily Activity/1_Artifical_Intelligence/3_Machine_Learning/2_Machine_Learning_Projects/1_ML_Used_Car_Dataset/venv\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LE:/1. Daily Activity/1_Artifical_Intelligence/3_Machine_Learning/2_Machine_Learning_Projects/1_ML_Used_Car_Dataset/venv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='E:/1. Daily Activity/1_Artifical_Intelligence/3_Machine_Learning/2_Machine_Learning_Projects/1_ML_Used_Car_Dataset/venv\Library\lib\tclstub86.lib'
